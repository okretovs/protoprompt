...
- Link GitHub branches, commits, pull requests, and Vercel preview URLs back to the relevant Linear issue when useful.
...
When a PRD is created from `/to-prd`, publish it to Linear as the source-of-truth issue or parent issue. If implementation is split with `/to-issues`, create child or related Linear issues and link them to the PRD issue.
